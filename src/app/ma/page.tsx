...
export default function App() {
  ...
  return (
    <div className="theme-wrapper relative h-[100dvh] w-full bg-dark">
...
function HeroSection() {
  return (
    <div className="theme-wrapper relative h-full w-full flex items-center justify-center overflow-hidden">
      <div

...
export function RoyalCrown({ className = '' }: { className?: string }) {
  return (
    <svg viewBox="0 0 100 60" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <circle cx="20" cy="15" r="3" fill="#F2CEC4" />
      <circle cx="50" cy="5" r="4" fill="#F2CEC4" />
      <circle cx="80" cy="15" r="3" fill="#F2CEC4" />
      <rect x="10" y="50" width="80" height="6" rx="1" fill="url(#crownGrad)" stroke="#D98C76" strokeWidth="1" />
      <defs>
        <linearGradient id="crownGrad" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#F2CEC4" />
          <stop offset="50%" stopColor="#D98C76" />
          <stop offset="100%" stopColor="#A85C46" />
        </linearGradient>
      </defs>
    </svg>
  );
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="5" cy="5" r="3" fill="#D98C76" />
      <path d="M15 15 Q25 15 25 25 Q25 35 35 35" stroke="#E7AC9C" strokeWidth="1" fill="none" strokeLinecap="round" />
      <circle cx="25" cy="25" r="2" fill="#F2CEC4" />
      <circle cx="35" cy="35" r="2" fill="#F2CEC4" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 40 50" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        strokeWidth="0.8"
      />
      <path d="M20 38 L20 48 M14 42 L26 42" stroke="#D98C76" strokeWidth="1.5" strokeLinecap="round" />
      <defs>

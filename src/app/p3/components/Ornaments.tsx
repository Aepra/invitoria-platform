...
export function RoyalCrown({ className = '' }: { className?: string }) {
  return (
    <svg viewBox="0 0 100 60" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      />
      <circle cx="20" cy="15" r="3" fill="#E4E7EC" />
      <circle cx="50" cy="5" r="4" fill="#E4E7EC" />
      <circle cx="80" cy="15" r="3" fill="#E4E7EC" />
      <rect x="10" y="50" width="80" height="6" rx="1" fill="url(#crownGrad)" stroke="#CDD2DA" strokeWidth="1" />
      <defs>
        <linearGradient id="crownGrad" x1="0" y1="0" x2="0" y2="1">
          <stop offset="0%" stopColor="#E4E7EC" />
          <stop offset="50%" stopColor="#CDD2DA" />
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinecap="round"
      />
      <circle cx="5" cy="5" r="3" fill="#CDD2DA" />
      <path d="M15 15 Q25 15 25 25 Q25 35 35 35" stroke="#CDD2DA" strokeWidth="1" fill="none" strokeLinecap="round" />
      <circle cx="25" cy="25" r="2" fill="#E4E7EC" />
      <circle cx="35" cy="35" r="2" fill="#E4E7EC" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 40 50" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      <path
        ...
        strokeWidth="0.8"
      />
      <path d="M20 38 L20 48 M14 42 L26 42" stroke="#CDD2DA" strokeWidth="1.5" strokeLinecap="round" />
      <defs>

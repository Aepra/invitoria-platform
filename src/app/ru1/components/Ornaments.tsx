...
export function FloralFrame({ className = '', size }: { className?: string; size?: number | string }) {
  return (
    <svg width={size || "100%"} height={size || "100%"} viewBox="0 0 200 200" className={className} fill="none" xmlns="http://www.w3.org/2000/svg">
      {/* Outer ring */}
